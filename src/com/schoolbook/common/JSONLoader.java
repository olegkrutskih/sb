...
public class JSONLoader {
	...
	// конструктор
	public JSONLoader(Context c) {
		this.context = c;
	}

	/**
	 * ѕолучить ответ по ссылке в формате json
	 * 
	 * @param url
	 *            запрашиваема€ страница
	 * @param method
	 *            GET or POST
	 * @param params
	...
	public ArrayList<HashMap<String, Object>> parseJson(InputStream in)
			throws IOException {
